...
root_path = '/data/ADERGHAL/ADNI_workspace/results/ADNI_des/F_32P_F10_MS3_MB04D/HIPP/3D/AD-NC/'
...
class SeNet3Hipp(nn.Module):
    def __init__(self):
        super(SeNet3Hipp, self).__init__()

        self.layer1 = nn.Sequential(
            nn.Conv2d(32, 50, kernel_size=7, stride=1, padding=0),
            SEWrapper(50, ratio),
            nn.BatchNorm2d(50),
            nn.ReLU())

        self.layer2 = nn.Sequential(
            nn.Conv2d(50, 80, kernel_size=5, stride=1, padding=0),
            SEWrapper(80, ratio),
            nn.ReLU())
        
        self.pool1 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0)

        self.fc1 = nn.Linear(80*11*11, 120)
